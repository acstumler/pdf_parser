...
# Encryption helpers (Plaid access tokens, sandbox only in your env)
try:
...
# Classifier + vendor utilities
from utils.clean_vendor_name import clean_vendor_name
from utils.classify_transaction import finalize_classification, record_learning
from utils.display_amount import compute_display_amount  # your accountant-view helper
...
def sync_transactions(user: Dict[str, Any] = Depends(require_auth)):
    ...
    for d in items:
        ...
        for a in accounts.get("accounts") or []:
            ...
            typ = (a.get("type") or "").lower().strip()  # 'depository' or 'credit'
